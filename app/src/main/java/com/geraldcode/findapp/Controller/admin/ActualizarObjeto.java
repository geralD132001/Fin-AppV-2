...
public class ActualizarObjeto extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView idObjetoUpdate, fechaRegistroObjetoUpdate, telefonoContactoObjetoUpdate,
    ...
    String idObjetoR, fechaRegistoObjetoR,
    ...
    private void ActualizarImagenObjetoDb(String uriImagen) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Objetos");
        databaseReference.child(idObjeto).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    private void ActualizarInformacionObjeto() {
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference("Objetos");

        Query query = databaseReference.orderByChild("idObjeto").equalTo(idObjetoR);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.actualizarObjetoMenu:
                ActualizarInformacionObjeto();

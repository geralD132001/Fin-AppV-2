...
public class ActualizarNota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void InicializarVistas() {
        idNotaUpdate = findViewById(R.id.idNotaUpdateUser);
        uidUsuarioNotaUpdate = findViewById(R.id.uidNotaUpdateUser);
        correoUsuarioNotaUpdate = findViewById(R.id.correoNotaUpdateUser);
        fechaRegistroNotaUpdate = findViewById(R.id.fechaRegistroNotaUpdateUser);
        fechaPerdidaNotaUpdate = findViewById(R.id.fechaPerdidaNotaUpdateUser);
        estadoNotaUpdate = findViewById(R.id.estadoNotaUpdateUser);
        tituloNotaUpdate = findViewById(R.id.tituloNotaUpdateUser);
        descripcionNotaUpdate = findViewById(R.id.descripcionNotaUpdateUser);
        btnCalendarNotaUpdate = findViewById(R.id.btnCalendarioNotaUpdateUser);
        tareaFinalizadaNotaUpdate = findViewById(R.id.tareaFinalizadaUpdateUser);
        tareaNoFinalizadaNotaUpdate = findViewById(R.id.tareaNoFinalizadaUpdateUser);
        spinnerStadoNotaUpdate = findViewById(R.id.spinnerEstadoNotaUpdateUser);
        estadoNuevoNotaUpdate = findViewById(R.id.estadoNuevoNotaUpdateUser);
    ...
    private void SpinnerEstado(){
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.estadosNotaUserUpdate, android.R.layout.simple_spinner_item);
    ...
    private void ActualizarNotaDb(){
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference("UsuariosCommons");

        //Consulta
        Query query = databaseReference.child(firebaseUser.getUid()).child("Notas_Publicadas_User").orderByChild("id_nota").equalTo(idNotaRecuperadoUpdate);
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(ActualizarNota.this, "Nota actualizada con éxito", Toast.LENGTH_SHORT).show();
                onBackPressed();

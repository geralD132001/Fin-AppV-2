package com.geraldcode.findapp.Controller.ActualizarPassword;
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        BD_Usuarios.child(firebaseUser.getUid()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                ...
                                Intent intent = new Intent(ActualizarPassUsuario.this, Login.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
